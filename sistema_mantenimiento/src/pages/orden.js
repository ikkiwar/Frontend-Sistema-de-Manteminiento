...
//constructor del calendario y hora
    ...
    render() {
        ...
        return (
                ...
                //imput text
                <div id="contenedor" className="content-section implementation" >  <Topbar/> <br></br>
                <h1>Solictud de Orden de Trabajo</h1>
                        <div id="uno">
                        ...
                        <span className="p-float-label">
                           ...
                           <div id="tres" className="p-col-12 p-md-4">
                        ...
                        <div id="cuatro" className="p-col-12 p-md-4">
